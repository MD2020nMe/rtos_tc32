...
#define semtstSTACK_SIZE			128 // configMINIMAL_STACK_SIZE
...
short sError = pdFALSE, sCheckVariableToUse;
	...
	portDEBUG_PRINTF("Sem testing started\n");
	...
	for( ;; )
	{
		...
		{
			portDEBUG_PRINTF("got semaphore block time %04x\n", pxParameters->xBlockTime);
